...
// const totalPopulation = prices.reduce((acc, curr) => acc + curr) 
...
// const odersTotal = orders.map(function (object) {
  
//   return object.price + (object.tax * object.price)  
// })


// // Arrow method 
// const ordersTotal = orders.map(object => object.price + (object.tax * object.price))


// console.log(afterSalesTax)
...
const bobsTotal = purchases.filter(function (object) {
